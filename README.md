...
![Screenshot of Python code that assigns "allow\_list.txt" to the import\_file variable][image1.png]

Then, I used a with statement to open the file:

![Screenshot of Python code that uses a with statement to open the file][image2.png] 
...
![Screenshot of Python code that includes the .read() method][image3.png]
...
![Screenshot of Python code that includes the .split() method][image4.png]
...
![Screenshot of Python code that includes the .join() method][image7.png]
...
![Screenshot of Python code that includes a with statement and the .write() method][image8,png]
